...
app.post('/slack', function(request, response) {
	response.send({"challenge":request.body.challenge, "text": "Click aqui -> " + host_app_url });
});
...
app.post('/coords', function(request, response) {
	...
	var attachment = {
		"attachments": [
			{
				"fallback": "Ubicaci&oacute;n enviada",
				"color": "#36a64f",
				"pretext": "Aqui la ubicaci&oacute;n aproximada",
